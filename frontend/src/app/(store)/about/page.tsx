...
export const metadata: Metadata = {
  title: 'About Us - Affordable Luxury Jewellery',
  description: 'Discover ORA\'s story — Premium fashion jewellery brand bringing everyday luxury under ₹1,500. Own. Radiate. Adorn.',
  alternates: {
    canonical: 'https://orashop.in/about',
  },
  openGraph: {
    title: 'About ORA Jewellery - Our Story',
    description: 'Premium affordable fashion jewellery for the modern woman. Discover the ORA story.',
    url: 'https://orashop.in/about',
  ...
  twitter: {
    ...
    title: 'About ORA Jewellery',
    description: 'Premium affordable fashion jewellery. Discover our story.',
