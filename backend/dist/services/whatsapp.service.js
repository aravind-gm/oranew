...
exports.sendWhatsAppOrderConfirmation = sendWhatsAppOrderConfirmation;
exports.sendWhatsAppShippingUpdate = sendWhatsAppShippingUpdate;
exports.sendWhatsAppDeliveryConfirmation = sendWhatsAppDeliveryConfirmation;
exports.sendWhatsAppMessage = sendWhatsAppMessage;
exports.notifyPartnersNewOrder = notifyPartnersNewOrder;
exports.notifyPartnersStatusUpdate = notifyPartnersStatusUpdate;
// ============================================
// TEMPLATE → PLAIN TEXT CONVERTER
// ============================================
function buildPlainTextBody(template, params) {
    switch (template) {
 ...
 */
async function sendWhatsAppOrderConfirmation(data) {
 ...
 */
async function sendWhatsAppShippingUpdate(data) {
    const provider = getProvider();
    return provider.send({
        to: formatPhone(data.phone),
 ...
 */
async function sendWhatsAppDeliveryConfirmation(data) {
    const provider = getProvider();
    return provider.send({
        to: formatPhone(data.phone),
 ...
 */
async function notifyPartnersNewOrder(data) {
 ...
 */
async function notifyPartnersStatusUpdate(data) {
    const DEFAULT_PARTNER_PHONES = '+919842253984,+919342865987,+919095007887';
    const partnerPhones = (process.env.PARTNER_PHONES || DEFAULT_PARTNER_PHONES).split(',').map(p => p.trim()).filter(Boolean);
    if (partnerPhones.length === 0)
        return;
