        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-8 lg:gap-12">
          ...
          <div className="col-span-2 sm:col-span-1 lg:col-span-1">
            ...
            <div className="flex gap-2 sm:gap-3">
              <a href="https://www.instagram.com/ora.adorn" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-all" aria-label="Instagram">
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-3">
              ...
              <li><Link href="/collections/combos" className="text-sm text-[#C6A85B]/80 hover:text-[#C6A85B] transition-colors inline-block py-1">✦ Free Ring Offer</Link></li>
